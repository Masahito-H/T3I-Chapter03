...
const WorkImage = (props) => {
    ...
    useFrame(() => {
        let groupRef2LastChild = groupRef2.current.children[groupRef2.current.children.length - 1];
        ...
        else if(groupRef2.current.position.y > -groupRef2LastChild.position.y){
            groupRef2.current.position.y = -groupRef2LastChild.position.y;
            setVelocity(velocity * .8);
        }
        else if(velocity > 0){
